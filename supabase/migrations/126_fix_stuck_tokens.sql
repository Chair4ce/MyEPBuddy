-- Migration: 126_fix_stuck_tokens.sql
-- Description: Reset tokens that were incorrectly marked as submitted and ensure function is correct
-- Author: System
-- Date: 2026-01-30

-- ============================================================================
-- FIX: Reset tokens that were marked submitted but have no feedback sessions
-- These are tokens that failed during submission
-- ============================================================================
...
WHERE status = 'submitted'
  AND id NOT IN (
    SELECT DISTINCT review_token_id FROM feedback_sessions
  )
  AND expires_at > now();

-- ============================================================================
-- RECREATE: submit_mentor_feedback function to ensure it's up to date
-- The function is transactional - if any insert fails, the whole thing rolls back
-- ============================================================================
...
BEGIN
  ...
  -- Insert comments with all fields (new and legacy)
  ...
  -- This happens AFTER all inserts succeed (transactional)
