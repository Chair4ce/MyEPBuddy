...
| Decoration | Abbreviation | Line Limit | Typical Recipients |
|------------|--------------|------------|-------------------|
| Legion of Merit | LOM | 15 lines | O-5+ / E-9 / Senior civilians |
| Bronze Star Medal | BSM | 15 lines | Combat meritorious service |
| Meritorious Service Medal | MSM | 15 lines | O-4+ / E-7+ / PCS/Retirement |
| Air and Space Commendation Medal | AFCM | 14 lines (10pt) or 8 lines (12pt) | E-5 to E-7 / O-1 to O-3 |
| Air and Space Achievement Medal | AFAM | 9 lines (10pt) or 6 lines (12pt) | E-1 to E-6 |
...
## Citation Structure (DAFMAN 36-2806)

### Universal Rules
1. **No abbreviations** except Jr., Sr., II, III (spell out USAF, DoD, AFB, etc.)
2. **No symbols** except $ (dollar sign)
3. **No leading zeros** on dates (use "1 Jan" not "01 Jan")
4. **Compound grades**: Spell out fully first time ("Staff Sergeant"), then short title ("Sergeant")
5. **Never separate rank from name**
6. **Times New Roman** 10pt or 12pt font
7. **8.5" x 11" landscape** orientation
...
1. [ ] Download DAFMAN 36-2806 PDF for exact requirements
2. [ ] Create award-specific prompt templates
3. [ ] Build UI for award type selection
4. [ ] Integrate with existing EPB statement selection
5. [ ] Add character/line counting validation
6. [ ] Test against real citation examples

---

*Research compiled: 2026-01-29*
*Source: airforcewriter.com, armywriter.com, Wikipedia, AFPC fact sheets*
